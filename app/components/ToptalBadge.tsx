import './toptal-badge.css'

const HIRE_URL = 'https://www.toptal.com/designers/resume/king-david-amoah#wn8dvD'

export default function ToptalBadge() {
  return (
    <a
      href={HIRE_URL}
      target="_blank"
      ...
      aria-label="Toptal Top 3% Talent — Hire me on Toptal"
    >
      <div className="toptal-badge__frame">
        <div className="toptal-badge__inner">
          <svg viewBox="0 0 60 17" xmlns="http://www.w3.org/2000/svg" aria-hidden>
            <path
          ...
          <h3 className="toptal-badge__title">TOP 3% TALENT</h3>
          <div className="toptal-badge__rule" />
          <span className="toptal-badge__label">Vetted by</span>
          <svg viewBox="0 0 108 30" xmlns="http://www.w3.org/2000/svg" aria-hidden>
          ...
          <span className="toptal-badge__cta">Hire me</span>
        </div>
      </div>
    </a>
  )
