...
import { signageProjectSections } from '#/data/signageProject'
import { createFileRoute } from '@tanstack/react-router'
import { useRef, useState } from 'react'

export const Route = createFileRoute('/signage-projects')({
  component: SignageProjectsPage,
})

// function RouteComponent() {
//   return <div>Hello "/signage-projects"!</div>
// }


function SignageProjectsPage() {
      ...
      <div className="min-h-screen bg-[var(--color-bg)]">
        ...
        <main className="page-frame mx-auto max-w-[1400px] pb-16 pt-54 md:pb-24 md:pt-32">
          ...
          <div className="space-y-12 md:space-y-16">
            {signageProjectSections?.map((section) => (
